...
def add_parser_args(parser):
    ...
    parser.add_argument("--dump_path", type=str, default="fscoach_exp", help="Experiment saved root path")
    ...
    parser.add_argument("--raw_data_path", type=str, default="../data/smp2020ecdt/smp2020ecdt_task1_v2")
