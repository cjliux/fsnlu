...
def add_parser_args(parser):
    ...
    parser.add_argument("--dump_path", type=str, default="coach_exp", help="Experiment saved root path")
    ...
    parser.add_argument("--evl_dm", type=str, default="", help="eval_domain")
    parser.add_argument("--tgt_dm", type=str, default="", help="target_domain")
    parser.add_argument("--emb_file", type=str, default="./data/snips/emb/slu_word_char_embs.npy", help="embeddings file")  
    ...
    parser.add_argument("--slot_emb_file", type=str, default="./data/snips/emb/slot_word_char_embs_based_on_each_domain.dict", help="dictionary type: slot embeddings based on each domain") 
    ...
    # few shot learning
    parser.add_argument("--n_samples", type=float, default=0, help="number of samples for few shot learning")
